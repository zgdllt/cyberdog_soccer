...
async def main(args=None):
    ...
    # 等待直到收到有效的位置消息
    opponent_location_subscriber1 = LocationSubscriber('other_location_subscriber','betago1')
    opponent_location_subscriber2 = LocationSubscriber('other_location_subscriber2','betago1')
